...
for months in range(1, 37):
    ...
    if months % 6 == 0:
        print(f"    Generated {months}-month forecasts")
...
print(f"    ARIMA complete: {len(arima_df)} forecasts saved")
print()

# ============================================================================
# 2. NAIVE FORECASTS (1-36 months)
# ============================================================================
print(" Generating Naive forecasts (1-36 months)...")
...
print(f"    Naive complete: {len(naive_df)} forecasts saved")
print()

# ============================================================================
# 3. PROPHET FORECASTS (1-36 months)
# ============================================================================
print(" Generating Prophet forecasts (1-36 months)...")
...
print(f"    Prophet complete: {len(prophet_df)} forecasts saved")
print()

# ============================================================================
# 4. LSTM FORECASTS (1-12 months only)
# ============================================================================
print(" Generating LSTM forecasts (1-12 months)...")
print("     This will take 2-3 minutes with GPU training...")
import joblib
...
try:
    ...
    print(f"    LSTM complete: {len(lstm_df)} forecasts saved")
    
except Exception as e:
    print(f"    LSTM failed: {e}")
    print(f"     LSTM forecasts not generated - will fall back to real-time in app")
    metadata['models']['LSTM'] = {
        'status': 'failed',
        'error': str(e)
    }
...
print(f"\n Next step: Deploy Streamlit app - forecasts will load instantly!")
print("="*60)
